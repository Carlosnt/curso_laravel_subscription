        ...
        <form class="form mt-10" action="#" @submit.prevent="sendContact">
            <div class="form__row">
                <div class="form__input-group">
                    ...
                    </div><input v-model="formData.name" id="name" autocomplete="false"  class="form__input">
                </div>
            </div>
            <div class="form__row">
                <div class="form__input-group">
            ...
            <div class="mt-6 pt-3 text-center">
                <button type="submit" :disabled="preloader" class="button button--filled button--primary">
                    <span v-if="preloader">Enviando...</span>
                    <span v-else="preloader">Enviar</span>
                </button></div>
    ...
    methods: {
        sendContact(){
            ...
            axios.post('/api/contact',{...this.formData})
                ...
                .catch(error => this.messageFail = 'Erro ao enviado o contato')
                .finally(() => {
                    this.preloader = true
                    this.reset()
                });
